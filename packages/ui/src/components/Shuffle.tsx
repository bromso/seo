    ...
    () => {
      ...
      const build = () => {
        ...
        chars.forEach((ch) => {
          ...
          firstOrig.className = `text-left ${shuffleDirection === "up" || shuffleDirection === "down" ? "block" : "inline-block"}`
          Object.assign(firstOrig.style, { width: `${w}px`, fontFamily: computedFont })

          ch.setAttribute("data-orig", "1")
          ch.className = `text-left ${shuffleDirection === "up" || shuffleDirection === "down" ? "block" : "inline-block"}`
          ...
          for (let k = 0; k < rolls; k++) {
            ...
            c.className = `text-left ${shuffleDirection === "up" || shuffleDirection === "down" ? "block" : "inline-block"}`
