...
import { type FC, Suspense, useEffect, useLayoutEffect, useMemo, useRef } from "react"
...
const ModelInner: FC<ModelInnerProps> = ({
  ...
  }, [content, autoFrame, camera, fadeIn, initPitch, initYaw, onLoaded, pivot.copy])
  ...
  }, [gl, enableManualRotation, enableManualZoom, minZoom, maxZoom, camera.position])
