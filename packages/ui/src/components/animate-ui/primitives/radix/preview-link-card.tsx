...
type PreviewLinkCardTriggerProps = HoverCardTriggerPropsPrimitive & React.ComponentProps<"a">
...
type PreviewLinkCardContentProps = HoverCardContentPropsPrimitive & React.ComponentProps<"a">
