...
} from "@repo/ui/components/animate-ui/primitives/headless/popover"
import { cn } from "@repo/ui/lib/utils"
import type * as React from "react"

type PopoverProps<TTag extends React.ElementType = "div"> = PopoverPrimitiveProps<TTag>

function Popover<TTag extends React.ElementType = "div">(props: PopoverProps<TTag>) {
...
type PopoverPanelProps<TTag extends React.ElementType = "div"> = PopoverPanelPrimitiveProps<TTag>
...
type PopoverGroupProps<TTag extends React.ElementType = "div"> = PopoverGroupPrimitiveProps<TTag>
