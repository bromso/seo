...
export function OfflineBanner({ cachedAt }: Props = {}) {
  ...
  return (
    <div
      role="status"
      className="flex items-center gap-2 rounded-md border border-border-subtle bg-surface-raised px-3 py-2 text-[14px] text-ink-secondary"
    >
      <span aria-hidden className="h-2 w-2 rounded-full bg-status-caution" />
