...
interface CalendarDatePickerProps extends VariantProps<typeof multiSelectVariants> {
  id?: string
  className?: string
  date: DateRange
...
const CalendarDatePicker = React.forwardRef<HTMLButtonElement, CalendarDatePickerProps>(
  (
    {
    ...
    const handleMonthChange = React.useCallback(
      ...
      [timeZone, numberOfMonths, onDateSelect, yearFrom, yearTo, yearsRange, date]
    )
    ...
    const handleYearChange = React.useCallback(
      ...
      [timeZone, numberOfMonths, onDateSelect, monthFrom, monthTo, years, date]
    )
